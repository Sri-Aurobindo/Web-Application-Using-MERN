...
async function someTests() {
    console.log("Try getting members without logging in");
    try {
    ...
    console.log("Login as member, then try getting members");
    try {
        ...
        console.log(`getting members result: ${res.status}\n`);
    ...
    console.log("Login as admin, then getting members");
    try {
